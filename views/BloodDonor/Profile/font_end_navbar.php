    ...
    <div class="container">
      ...
      <?php  if (isset($_SESSION['donor_email'])){ ?>
          <div id="navbar" class="navbar-menu">
              ...
              <ul class="nav navbar-right" style="color: white">
                  <button type="button"class="btn btn-default" style="color: white"> <a href="donors-profile.php">Donors Profile</a></button>
      ...
      <?php } else {?>
        <div id="navbar" class="navbar-menu">
            ...
            <ul class="nav navbar-right" style="color: white">
                Are you blood donor?  <button type="button"class="btn btn-default" style="color: white"> <a href="signup.php">Sign up/Login</a></button>
            </ul>
        </div>
