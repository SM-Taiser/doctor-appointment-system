...
$allData = $objDoctor->new_doctor_req("obj");
...
<header class="tab-content">
    ...
    <div class="container">
<center>
        <iframe style="text-align: center" src="http://www.bmdc.org.bd/doctors-info/" width="500"height="500"></iframe></center>
        ...
        <div class="table-responsive">
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th class="text-center">BMDC Reg No</th>
                ...
                foreach ($allData as $oneData) {
                    ...
                    <tr>
                        ...
                        <td> <?php echo $oneData->bmdc_reg_no?></td>

                        <?php if($oneData->confirm==1){ ?>
                            <td class="btn-success"> Yes</td>
                        <?php } else{ ?>
                            <td class="btn-danger">No</td>
                        <?php } ?>


                        <td>
                            <form action="update_is_confirm.php" method="post">
                                <input type="hidden" name="id" value="<?php echo $oneData->id?>">
                                <input type="hidden" name="phone" value="<?php echo $oneData->phone?>">
                                <input type="hidden" name="confirm" value="1">
                                <input type="submit" value="Mark as Confirmed" class="btn btn-success">
                            </form>
