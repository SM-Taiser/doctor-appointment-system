...
<h3 class="text-info " style="font-size:22pt;color:darkblue;font-family: Georgia,serif">Registration Form</h3>
            <hr>
<form  id="myForm" class="form-horizontal" action="store.php" method="post" enctype="multipart/form-data" onsubmit="return(validate());">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control"  pattern="[A-Za-z0-9-&,/.() ]{5,80}" maxlength="50" id="lname" name="address" placeholder="Address" style="height:40px; padding: 10px;border:1px solid #51b6bf" required>
        </div>
    </div>
...
<script>
    function validate()
    {
        ...
        var t=document.getElementById('degree').value;
