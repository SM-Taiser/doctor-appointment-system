    ...
    <div class="row" align="left">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
            ...
            <div class="panel panel-info" >
                ...
                <h3 class="panel-title" style="color: white">Drivers Profile</h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class=" col-md-9 col-lg-9 ">
                        <table class="table table-user-information" style="color: black">
                            ...
                            <tr>
                                <td>Name</td>
                                <td><?php echo$singleUser->driver_name ?></td>
                            </tr>
                            ...
                            <tr>
                                <td>Ambulance No</td>
                                <td><?php echo $singleUser->ambulance_no ?></td>
                            </tr>

                            <tr>
                                <td>Specification </td>
                                <td><?php echo $singleUser->specification ?></td>
                            </tr>
                            ...
                            <tr>
                                <td>Availability</td>
                                <td><?php echo $singleUser->availability ?></td>
                            </tr>
            ...
            <div class="panel-footer" style="text-align: right">
                           ...
                           <a href="edit.php?driver_id=<?php echo $singleUser->driver_id ?>" class="btn btn-primary"  role="button" ><span
