...
$allData = $obj->manage_doctors_schedule();
        ...
        <div class="table-responsive">
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                foreach ($allData as $oneData) {
                    ...
                    ?>
                    <tr>
                        <td><?php echo $oneData->appointment_id; ?></td>
                        <td> <?php echo $oneData->name; ?></td>
                        <td> <?php echo $oneData->chamber_name; ?></td>
                        <td> <?php echo $oneData->day; ?></td>
                        <td> <?php echo $oneData->time; ?></td>

                        <td>   <a href="edit.php?appointment_id=<?php echo $oneData->appointment_id?>&chamb_id=<?php echo $oneData->chamb_id?>&id=<?php echo $oneData->id?>" class="btn btn-info" role="button"><span
                                    class="glyphicon glyphicon-edit"></span> Edit</a>
                            <a href="delete.php?appointment_id=<?php echo $oneData->appointment_id ?>" class="btn btn-primary" role="button"><span
                                    class="glyphicon glyphicon-trash"></span> Delete</a>

                            <a href="view.php?appointment_id=<?php echo $oneData->appointment_id ?>&chamb_id=<?php echo $oneData->chamb_id?>&id=<?php echo $oneData->id?>" class="btn btn-success" role="button"><span
