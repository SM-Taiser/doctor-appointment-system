    ...
    <div class="container">
        ...
        <?php  if (isset($_SESSION['patient_email'])){ ?>
            <div id="navbar" class="navbar-menu">
                ...
                <ul class="nav navbar-right" style="color: white">
                    <button type="button"class="btn btn-default" style="color: white"> <a href="Profile/patient-profile.php">Patient Profile</a></button>
        ...
        <?php } else {?>
            <div id="navbar" class="navbar-menu">
                ...
                <ul class="nav navbar-right" style="color: white">
                 For doctor appointment you have to signup <button type="button"class="btn btn-default" style="color: white"> <a href="Profile/signup.php">Sign up/Login</a></button>
                </ul>
            </div>
