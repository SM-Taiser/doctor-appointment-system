...
if(!$status) {
    Utility::redirect('Patient/Profile/patient-login.php');
    return;
}
?>
...
<div>
    ...
    <form class="form-horizontal" action="update.php" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="lname" name="patient_email"  readonly="readonly" value="<?php echo  $singleItem->patient_email; ?>" placeholder="Email">
            </div>
        </div>
