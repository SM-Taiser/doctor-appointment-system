    ...
    <div class="container">
        ...
        <?php  if (isset($_SESSION['patient_email'])){ ?>
            <div id="navbar" class="navbar-menu">
                ...
                <ul class="nav navbar-right" style="color: white">
                    <button type="button"class="btn btn-default" style="color: white"> <a href="patient-profile.php">Patient Profile</a></button>
        ...
        <?php } else {?>
            <div id="navbar" class="navbar-menu">
                ...
                <ul class="nav navbar-right" style="color: white">
                    Want to booking doctor appointment?please signup now  <button type="button"class="btn btn-default" style="color: white"> <a href="signup.php">Sign up/Login</a></button>
                </ul>
            </div>
