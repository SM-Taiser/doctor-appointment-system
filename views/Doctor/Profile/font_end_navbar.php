    ...
    <div class="container">
      ...
      <?php  if (isset($_SESSION['email'])){ ?>
          <div id="navbar" class="navbar-menu">
              ...
              <ul class="nav navbar-right" style="color: white">
                  <button type="button"class="btn btn-default" style="color: white"> <a href="doctor-profile.php">Doctors Profile</a></button>
      ...
      <?php } else {?>
        <div id="navbar" class="navbar-menu">
            ...
            <ul class="nav navbar-right" style="color: white">
                Are you doctor?please signup  <button type="button"class="btn btn-default" style="color: white"> <a href="sign_up_doctor.php">Sign up/Login</a></button>
            </ul>
        </div>
