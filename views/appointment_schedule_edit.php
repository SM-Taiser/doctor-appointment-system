...
<div>
    ...
    $objDoctor = new  \App\Payment\Payment();
    $obj->prepare($_GET);
    var_dump($_GET);
    $singleItem  =  $obj->view();
    var_dump($singleItem);
    ...
    <form class="form-horizontal" action="update.php" method="post" enctype="multipart/form-data">
        <input type="text" value="<?php echo $singleItem->schedule_id; ?>" id="fname" name="schedule_id" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="lname" name="time" value="<?php echo $singleItem->time; ?>" placeholder="Time">
            </div>
        </div>
