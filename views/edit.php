   ...
   ?>
    ...
    <form class="form-horizontal" action="update.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="lname" name="degree" value="<?php echo $singleItem->degree; ?>" placeholder="Area Coverage">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select class="form-control" id="country" name="is_active">
                    <option value="Yes"<?php if($singleItem->is_active == "Yes") { ?>selected="selected"<?php  }?>>Active</option>
                    <option value="No"<?php if($singleItem->is_active == "No") { ?>selected="selected"<?php  }?>>Inactive</option>
